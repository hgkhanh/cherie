const config = {
  ...
  userName: "Chérie", // Username to display in the author segment.
  userEmail: "info@cheriebridal.fi", // Email used for RSS feed's author segment
  ...
  PageLinks: [
    ...
    {
      label: "Email",
      url: "mailto:info@cheriebridal.fi",
      iconClassName: "fa fa-envelope"
    }
  ],
  copyright: "Copyright © 2020. Chérie.fi", // Copyright string for the footer of the website and RSS feed.
  themeColor: "#e8c7b5", // Used for setting manifest and progress theme colors.
